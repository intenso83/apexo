...
class Es implements En {
  ...
  Map<String, String> dictionary = {
    ...
    "addShoppingItem": "Añadir material",
    "editShoppingItem": "Editar material",
    "manageShoppingCategories": "Gestionar categorías",
    "allShoppingCategories": "Todas las categorías",
    "newShoppingCategory": "Nueva categoría",
    "editShoppingCategory": "Editar categoría",
    "showNeededOnly": "Solo artículos para comprar",
    "noShoppingItems": "No hay materiales en esta vista",
    "shoppingMaterial": "Material",
    "shoppingVariant": "Variante",
    "shoppingVariants": "Variantes",
    "shoppingVariantsHint": "Separar variantes con comas",
    "shoppingCategory": "Categoría",
    "shoppingItems": "materiales",
    "quantity": "Cantidad",
    "shoppingPriority": "Prioridad",
    "noVariants": "—",
    "selectVariant": "Seleccionar",
    "priorityNormal": "Normal",
    "prioritySoon": "Comprar pronto",
    "priorityUrgent": "Urgente",
    "urgentShoppingList": "Lista urgente",
    "urgentShoppingListDescription":
        "Los artículos rojos seleccionados aparecen aquí automáticamente.",
    "noUrgentShoppingItems": "No hay artículos urgentes",
    "deleteShoppingItem": "Eliminar material",
    "deleteShoppingItemQuestion": "¿Eliminar este material?",
    "shoppingCategoryInUse": "La categoría está en uso",
    "shoppingCategoryInUseDescription":
        "Mueva o elimine sus materiales antes de borrar la categoría.",
    "showInLabworks": "Mostrar en trabajos de laboratorio",
    "insights": "Análisis",
    ...
    "medicalHistoryDescription":
        "Cada guardado crea una revisión auditable. Las revisiones anteriores nunca se sobrescriben.",
    "newMedicalHistoryRevision": "Nueva revisión de historia médica",
    "noMedicalHistory": "Todavía no se ha registrado una historia médica.",
    "revision": "Revisión",
    "pendingReview": "Pendiente de revisión",
    "confirmed": "Confirmado",
    "superseded": "Reemplazado",
    "staffManual": "Entrada manual del personal",
    "dentalWinImport": "Importación de DentalWin",
    "tabletEntry": "Entrada desde tableta",
    "ocrImport": "Importación de papel/OCR",
    "reasonForVisit": "Motivo de la visita",
    "presentCondition": "Estado actual",
    "treatingPhysician": "Médico tratante / atención actual",
    "diseasesSurgeries": "Enfermedades, cirugías y otros datos médicos",
    "generalMedicalNotes": "Notas generales de historia médica",
    "answerYes": "Sí",
    "answerNo": "No",
    "medicalNotApplicable": "No aplicable",
    "additionalDetails": "Detalles, medicación, fechas o reacción",
    "patientConfirmed": "El paciente confirmó la información",
    "paperSignaturePresent": "Existe un formulario en papel firmado",
    "saveRevision": "Guardar nueva revisión",
    "cancelRevision": "Cancelar revisión",
    "importedNeedsReview": "Valor importado — requiere revisión del personal",
    "positiveAnswers": "Respuestas positivas",
    "noPositiveAnswers": "No hay respuestas positivas registradas",
    "legacyImportedText": "Información importada de DentalWin",
    "age": "Edad",
    "gender": "Género",
    ...
    "customOdontogramTreatment": "Tratamiento libre",
    "customOdontogramTreatmentDescription":
        "Solo para este paciente. No se añade al catálogo ni crea un cargo automáticamente.",
    "customTreatmentNameRequired": "Nombre del tratamiento *",
    "customTreatmentPriceRequired": "Precio *",
    "customTreatmentPatientScope":
        "Tratamiento general del paciente (sin diente)",
    "customTreatmentNotes": "Descripción / notas",
    "recordCustomOdontogramTreatment": "Registrar tratamiento libre",
    "customTreatmentReferencePrice": "Precio de referencia (sin cargo)",
    ...
    "treatmentPaymentSettle": "Pagar en su totalidad",
    "treatmentPaymentAddPartial": "Registrar pago parcial",
    "treatmentPaymentHistory": "Pagos del tratamiento",
    ...
    "finances": "Finanzas",
    "financesScopeNote":
        "Este registro incluye solo pagos vinculados a tratamientos de Apexo con cargos confirmados. Los pagos anteriores por cita y los importes importados de DentalWin se muestran por separado y no se suman aquí.",
    "confirmedTreatmentCharges": "Cargos de tratamientos confirmados",
    "collectedTreatmentIncome": "Pagos de tratamientos recibidos",
    "outstandingTreatmentBalances": "Saldos pendientes de tratamientos",
    "incomeTransactions": "Registro de pagos de tratamientos",
    "noTreatmentPayments": "Aún no se han registrado pagos de tratamientos",
    "moreTransactions": "Mostrar más pagos",
    "recordedExpenses": "Gastos registrados",
    "expensesScopeNote":
        "Los totales de gastos usan los campos existentes de coste de pedido e importe pagado. Se mantienen separados de los ingresos de pacientes; los pagos de gastos no tienen fechas individuales en el modelo actual.",
    "recordedExpenseCosts": "Costes de gastos",
    "recordedSupplierPayments": "Pagado a proveedores",
    "supplierBalanceFromAmounts": "Saldo de proveedores según importes",
    "noExpenseOrders": "Aún no se han registrado pedidos de gastos",
    "moreExpenseOrders": "Mostrar más gastos",
    ...
    "laboratoryCatalogue": "Laboratorios",
    "laboratoryPartners": "Laboratorios asociados",
    "addLaboratory": "Agregar laboratorio",
    "laboratoryName": "Nombre del laboratorio",
    "selectLaboratory": "Seleccionar laboratorio",
    "noLaboratories": "No hay laboratorios guardados",
    "createLaboratoryFirst": "Agregue primero un laboratorio y sus precios.",
    "laboratoryDetailsAndPrices": "Datos y precios del laboratorio",
    "laboratoryPriceList": "Lista de precios de tratamientos",
    "laboratoryAssignment": "Laboratorio protésico",
    "laboratoryCost": "Costo de laboratorio",
    "removeFromLaboratories": "Quitar de laboratorios",
    "contactName": "Persona de contacto",
    "mobile": "Móvil",
    "basePrice": "Precio al paciente",
    "laboratoryRequirement": "Asignación de laboratorio",
    "laboratoryAutomatic": "Automático para tratamientos protésicos",
    "laboratoryRequired": "Mostrar siempre la selección de laboratorio",
    "laboratoryNotRequired": "Sin selección de laboratorio",
    "month": "mes",
    "labwork": "Trabajo",
    ...
    "items": "Ítems",
    "expenseItemCatalogue": "Catálogo de artículos",
    "expenseItemCatalogueDesc":
        "Guarde artículos reutilizables y selecciónelos en cada gasto.",
    "newExpenseItem": "Nuevo artículo",
    "deleteTreatment": "Eliminar tratamiento",
    "clinicSettingsGroup": "Configuración de la clínica",
    "clinicSettingsGroup_desc":
        "Preferencias compartidas, iguales en las ediciones web y beta.",
    "administrationSettingsGroup": "Administración del sistema",
    "administrationSettingsGroup_desc":
        "Servidor, autenticación, almacenamiento, correo y copias de seguridad.",
    "managedByAdministrator":
        "Un administrador del sistema gestiona esta configuración.",
