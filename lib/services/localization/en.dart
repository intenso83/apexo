...
class En {
  ...
  Map<String, String> dictionary = {
    ...
    "medicalHistoryDescription":
        "Each save creates a new auditable revision. Existing revisions are never overwritten.",
    "newMedicalHistoryRevision": "New medical-history revision",
    "noMedicalHistory": "No medical-history revision has been recorded yet.",
    "revision": "Revision",
    "pendingReview": "Pending review",
    "confirmed": "Confirmed",
    "superseded": "Superseded",
    "staffManual": "Staff manual entry",
    "dentalWinImport": "DentalWin import",
    "tabletEntry": "Tablet entry",
    "ocrImport": "Paper/OCR import",
    "reasonForVisit": "Reason for visit",
    "presentCondition": "Present condition",
    "treatingPhysician": "Treating physician / ongoing care",
    "diseasesSurgeries": "Diseases, surgery, and other medical details",
    "generalMedicalNotes": "General medical-history notes",
    "answerYes": "Yes",
    "answerNo": "No",
    "medicalNotApplicable": "Not applicable",
    "additionalDetails": "Details, medication, dates, or reaction",
    "patientConfirmed": "Patient confirmed the information",
    "paperSignaturePresent": "Signed paper form is present",
    "saveRevision": "Save new revision",
    "cancelRevision": "Cancel revision",
    "importedNeedsReview": "Imported value — staff review required",
    "positiveAnswers": "Positive answers",
    "noPositiveAnswers": "No positive answers recorded",
    "legacyImportedText": "Imported DentalWin information",
    "age": "Age",
    "gender": "Gender",
    ...
    "customOdontogramTreatment": "Free-text treatment",
    "customOdontogramTreatmentDescription":
        "For this patient only. Not added to the catalogue and does not automatically create a charge.",
    "customTreatmentNameRequired": "Treatment name *",
    "customTreatmentPriceRequired": "Price *",
    "customTreatmentPatientScope": "Patient-level treatment (no tooth)",
    "customTreatmentNotes": "Description / notes",
    "recordCustomOdontogramTreatment": "Record free-text treatment",
    "customTreatmentReferencePrice": "Reference price (not charged)",
    ...
    "treatmentPaymentSettle": "Pay in full",
    "treatmentPaymentAddPartial": "Record partial payment",
    "treatmentPaymentHistory": "Treatment payments",
    ...
    "finances": "Finances",
    "financesScopeNote":
        "This ledger includes payments linked to explicitly confirmed Apexo treatments only. Older appointment payments and imported DentalWin values are shown separately and are not added here.",
    "confirmedTreatmentCharges": "Confirmed treatment charges",
    "collectedTreatmentIncome": "Treatment payments received",
    "outstandingTreatmentBalances": "Treatment balances due",
    "incomeTransactions": "Treatment payment ledger",
    "noTreatmentPayments": "No treatment payments have been recorded yet",
    "moreTransactions": "Show more payments",
    "recordedExpenses": "Recorded expenses",
    "expensesScopeNote":
        "Expense totals use existing order cost and paid-amount fields. They are separate from patient income; expense payments do not have individual dates in the current data model.",
    "recordedExpenseCosts": "Expense costs",
    "recordedSupplierPayments": "Paid to suppliers",
    "supplierBalanceFromAmounts": "Supplier balance from amounts",
    "noExpenseOrders": "No expense orders have been recorded yet",
    "moreExpenseOrders": "Show more expenses",
    ...
    "clinicSettingsGroup_desc":
        "Shared clinic preferences. These settings are identical in the web and beta editions.",
